...
@section('content')
    ...
    <div class='col-lg-7 col-lg-offset-4'>
        ...
        <h5><i class='fa fa-language'></i> مترجم جدید</h5>
        <hr>
        @if (\Session::has('flash_success'))
            ...
            <a class="btn btn-secondary" href="{{ route('translator.list') }}" role="button"> هلیست مترجمین</a>
        @elseif (\Session::has('flash_error'))
            ...
            <a class="btn btn-secondary" href="{{ route('translator.list') }}" role="button">لیست مترجمین</a>
        @else
            @if ($errors->any())
                <div class="alert alert-danger">
                    <ul>
            ...
            {{ Form::open(array('url' => 'translator','method'=>'POST', 'files'=>true)) }}
            ...
            <div class="form-group">
                ...
                {{ Form::text('torder', '', array('class' => 'form-control')) }}
            </div>
            ...
            <a class="btn btn-secondary" href="{{ route('translator.list') }}?page={{ request()->get('page' , 1) }}" role="button">بازگشت</a>
