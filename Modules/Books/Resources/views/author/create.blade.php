...
@section('content')
    ...
    <div class='col-lg-7 col-lg-offset-4'>
        ...
        <h5><i class='fa fa-pencil'></i> نویسنده جدید</h5>
        <hr>
        @if (\Session::has('flash_success'))
            ...
            <a class="btn btn-secondary" href="{{ route('author.list') }}" role="button">لیست نویسندگان</a>
        ...
        @else
            ...
            {{ Form::open(array('url' => 'author','method'=>'POST', 'files'=>true)) }}
            ...
            <div class="form-group">
                ...
                {{ Form::text('aorder', '', array('class' => 'form-control')) }}
            </div>
            ...
            <a class="btn btn-secondary" href="{{ route('author.list') }}?page={{ request()->get('page' , 1) }}" role="button">بازگشت</a>
